...
$string['type'] = 'Tipo';
$string['typequestionsanswers'] = 'Perguntas & respostas';
$string['typedialogue'] = 'Diálogo';
...
$string['baseurl_help'] = 'A URL base para o endpoint da API.';
...
$string['pagebehavior_help'] = 'Escolha como a avaliação do modelo IA funciona: Contínua (conversa contínua), Turnos (navegação por turnos com árvore de conversa), Multi-modelo (futuro).';
...
$string['aibehaviorqa'] = 'Pergunta e resposta';
